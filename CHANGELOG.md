...
-   Drag-and-drop support for reorganising folders and commands directly inside the
    Commands Manager Next command tree view.
...
This is the initial stable release of Commands Manager Next (formerly Command Manager). The extension provides a comprehensive solution for managing and executing commands in VS Code with advanced features like variable substitution, command chaining, documentation integration, and a configurable test runner.
